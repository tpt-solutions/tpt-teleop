...
unsafe impl tpt_teleop_ring::cast::PlainBytes for ImuSample {}
...
unsafe impl tpt_teleop_ring::cast::PlainBytes for GpsSample {}
...
unsafe impl tpt_teleop_ring::cast::PlainBytes for TelemetryPacket {}
...
mod tests {
    use super::*;
    use tpt_teleop_ring::cast::{bytes_of, ref_from_bytes};
